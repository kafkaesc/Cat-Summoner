	...
	return (
		<Layout>
			<Head>
				...
				{/* OpenGraph Meta Tags */}
				<meta property="og:description" content="About Cat Summoner: all the technical details you do (and don't) want to know. Make new friends. Call a cat by name, wait a few seconds, and see a photo of them appear. Collect new photos in your Catbook, stored locally in your browser." />
				...
				<meta name="twitter:description" content="About Cat Summoner: all the technical details you do (and don't) want to know. Make new friends. Call a cat by name, wait a few seconds, and see a photo of them appear. Collect new photos in your Catbook, stored locally in your browser." />
